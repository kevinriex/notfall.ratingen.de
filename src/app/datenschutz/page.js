export default function ImpressumPage() {
    return (
        <div className="px-4 py-5 my-5 container">
            ...
            <p>
                <span id="s3-t-firma">Stadt Ratingen</span>
                <br />
                <span id="s3-t-ansprechpartner">
                    Der Datenschutzbeauftragte
                </span>
                <br />
                <span id="s3-t-strasse">Minoritenstraße 2-6</span>
                <br />
                <span id="s3-t-plz">40878</span>{" "}
                <span id="s3-t-ort">Ratingen</span>
            </p>
            <p>
            ...
            <p>
                Wir verwenden zur ordnungsgemäßen Bereitstellung der Inhalte
                unserer Website Font Awesome des Anbieters Fonticons, Inc..
            </p>
            <h3>Zweck und Rechtsgrundlage</h3>
            <p>
                Der Einsatz von Font Awesome erfolgt auf Grundlage Ihrer
                Einwilligung gemäß Art. 6 Abs. 1 lit. a. DSGVO und § 25 Abs. 1
                TTDSG.
            </p>
            <p>
                Wir beabsichtigen personenbezogenen Daten an Drittländer
            ...
            <p>
                ...
                Einwilligung nach Art. 49 Abs. 1 Satz 1 lit. a. DSGVO ein, die
                Sie über die Einwilligung im Consent Manager (oder sonstigen
                Formularen, Registrierungen etc.) erteilen. Wir weisen Sie
                darauf hin, dass bei Drittlandübermittlungen im Detail
                unbekannte Risiken (z.B. die Datenverarbeitung durch
                Sicherheitsbehörden des Drittlandes, deren genauer Umfang und
