            ...
            <div className="px-4 py-5 my-5 text-center" data-bs-theme="light">
                ...
                <div className="col-lg-8 mx-auto">
                    <p className="lead mb-4 mt-4">
                        ...
                        <br />
                        <br />
                        Eine Änderung gibt es an den genannten Tagen in Bezug auf die telefonische Erreichbarkeit der Verwaltung über die Zentralnummer <StyledLink href="tel:02102 550 0"/>. Da der Vermittlungsdienst über diese Nummer durch den Kreis Mettmann erfolgt, die Kreisverwaltung aber zwischen Weihnachten und Neujahr komplett geschlossen ist, können an diesen Tagen keine Anrufe über die <StyledLink href="tel:02102 550 0"/> angenommen werden. Der Kreis Mettmann wird per Ansagetext auf diese Einschränkung hinweisen. 
                        <br />
                        <br />
